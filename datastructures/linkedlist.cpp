...
{
    public:
    void insert_at_head(int data, Node* &head, Node* &tail)// Now, this can be written as void insert_at_head(int data, Node* &head) as this will send reference of the head.
    {
...
int main()
{
    ...
    f.display(head);
    cout<<f.delete_at_head(&head)<<endl;
    cout<<f.delete_at_tail(&tail)<<endl;
